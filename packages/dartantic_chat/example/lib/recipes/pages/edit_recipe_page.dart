...
class _EditRecipePageState extends State<EditRecipePage> {
  ...
  final _provider = DartanticProvider(
    agent: Agent('gemini'),
    systemPrompt: '''
...
When you generate a recipe, you should generate a JSON object with this format:
{
  "modifications": "Description of the modifications you made",
  "recipe": {
    "title": "Recipe Title",
