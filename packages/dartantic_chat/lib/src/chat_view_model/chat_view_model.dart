...
/// interface, including the chat history provider, style configuration, welcome
/// message, response builder, and message sender.
class ChatViewModel {
  /// Creates a new [ChatViewModel] instance.
  ///
  /// [provider] is the required [ChatHistoryProvider] for handling chat
  /// interactions. [style] is the optional [ChatViewStyle] for customizing
  /// the chat view's appearance. [welcomeMessage] is an optional message
  /// displayed when the chat interface is first opened. [responseBuilder] is an
  /// optional builder for customizing chat responses. [messageSender] is an
  /// optional [ChatStreamGenerator] for sending messages. [enableAttachments]
  /// and [enableVoiceNotes] are optional boolean flags for enabling or
  /// disabling file and voice note attachments in the chat input.
  const ChatViewModel({
  ...
  /// suggestions to quickly start a conversation with the agent.
  ...
  ///
  /// This optional generator is used to send messages to the agent, allowing
  /// for asynchronous communication and response handling.
  final ChatStreamGenerator? messageSender;
