...
class MessageStyle {
  ...
  ///
  /// This method creates a new [MessageStyle] by combining the provided
  ...
  factory MessageStyle.resolve(
    ...
    defaultStyle ??= MessageStyle.defaultStyle();
    return MessageStyle(
  ...
  factory MessageStyle.defaultStyle() => MessageStyle._lightStyle();

  /// Provides a default light style.
  factory MessageStyle._lightStyle() => MessageStyle(
